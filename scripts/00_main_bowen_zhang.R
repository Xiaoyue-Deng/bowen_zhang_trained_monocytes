...
# === Process data ===
set.seed(666)
setwd("Z:/Xiaoyue/1.Studies/scRNA/Bowen_Zhang")

# Load the already annotated obj here:
combined_integrated <- readRDS("./rds_obj/17032026_combined_seu_mono_manual_annotation.rds")

# Quick check
DimPlot(combined_seu_mono)

# If things look good, continue to the section of visualization.
